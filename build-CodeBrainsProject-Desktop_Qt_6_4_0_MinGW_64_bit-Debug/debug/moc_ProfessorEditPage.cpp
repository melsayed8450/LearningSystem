...
#include <memory>
#include "../../../../Learning system/CodeBrains---Last/CodeBrains project/ProfessorEditPage.h"
...
Q_CONSTINIT static const qt_meta_stringdata_ProfessorEditPage_t qt_meta_stringdata_ProfessorEditPage = {
    {
        ...
        QT_MOC_LITERAL(18, 10),  // "saveSignal"
        QT_MOC_LITERAL(29, 0),  // ""
        QT_MOC_LITERAL(30, 36),  // "on_allCoursesTable_cellDouble..."
        QT_MOC_LITERAL(67, 3),  // "row"
        QT_MOC_LITERAL(71, 6),  // "column"
        QT_MOC_LITERAL(78, 27),  // "on_deletePushButton_clicked"
        QT_MOC_LITERAL(106, 25)   // "on_savePushButton_clicked"
    },
    "ProfessorEditPage",
    "saveSignal",
    "",
...
void ProfessorEditPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ProfessorEditPage::*)();
            if (_t _q_method = &ProfessorEditPage::saveSignal; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ProfessorEditPage::saveSignal()
{
