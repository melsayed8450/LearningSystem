...
public:
    ...
    QPushButton *deletePushButton_3;
    QLabel *label_3;
    QPushButton *SavePushButton;
    QWidget *widget;
    ...
    void setupUi(QDialog *CourseEditPage)
    {
        ...
        deletePushButton_3 = new QPushButton(layoutWidget);
        deletePushButton_3->setObjectName("deletePushButton_3");

        verticalLayout_5->addWidget(deletePushButton_3);
        ...
        widget = new QWidget(CourseEditPage);
        widget->setObjectName("widget");
        widget->setGeometry(QRect(320, 140, 128, 36));
        ...
        widget1 = new QWidget(CourseEditPage);
        widget1->setObjectName("widget1");
        widget1->setGeometry(QRect(780, 140, 281, 36));
        ...
        dayComboBox = new QComboBox(widget1);
        ...
        widget2 = new QWidget(CourseEditPage);
        widget2->setObjectName("widget2");
        widget2->setGeometry(QRect(500, 140, 251, 36));
        ...
        lecHallCBox = new QComboBox(widget2);
        ...
        widget3 = new QWidget(CourseEditPage);
        widget3->setObjectName("widget3");
        widget3->setGeometry(QRect(30, 250, 525, 304));
        ...
        allStudentsTable = new QTableWidget(widget3);
        ...
        addedStudentsTable = new QTableWidget(widget3);
        ...
        deletePushButton = new QPushButton(widget3);
    ...
    void retranslateUi(QDialog *CourseEditPage)
    {
        ...
        deletePushButton_3->setText(QCoreApplication::translate("CourseEditPage", "Delete", nullptr));
        ...
        deletePushButton->setText(QCoreApplication::translate("CourseEditPage", "Delete", nullptr));
